...
# Fallback to absolute paths as per config logic
...
def run_packaging_job(job_id: str, source_dir: str, settings_dict: dict):
    ...
    try:
        ...
        job_settings = PhotoPackagerSettings(
            ...
            generate_jpg=True, # Driven by detailed flags below but keeping backwards compatibility
            generate_webp=True,
        ...
        # Convert JobSummary to dictionary explicitly
        return {
