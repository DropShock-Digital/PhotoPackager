...
class JobSettings(BaseModel):
    ...
    # Local Path Config (No Uploads)
    input_path: str = Field(..., description="Absolute path to the source folder.")
    output_path: str = Field(..., description="Absolute path to save results.")
    ...
    watermark_path: str = ""
    watermark_position: str = "bottom_right" # 'center', 'tile', 'bottom_right', 'bottom_left'
